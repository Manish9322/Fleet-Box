...
const navItems = [
  ...
  { href: "/admin/cabs", icon: Car, label: "Cab Catalog" },
  { href: "/admin/bookings", icon: BookCopy, label: "Booking History" },
  { href: "/admin/transactions", icon: Wallet, label: "Transaction Log" },
